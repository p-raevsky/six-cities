...
function Logo(props) {
  const {isHeader = true, isMainPageActive} = props;
  ...
  return (
    <Link className={isActiveClassName + isHeaderClassName} to="/">
      <img className={isHeader ? 'header__logo' : 'footer__logo'} src="img/logo.svg" alt="6 cities logo" width={isHeader ? '81' : '64'} height={isHeader ? '41' : '33'} />
    </Link>
  );
}
